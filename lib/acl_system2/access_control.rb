...
module ACLSystem2
  module AccessControl
    def self.included(subject)
      ...
      return unless subject.respond_to? :helper_method
    ...
    def access_handler
      @access_handler ||= if respond_to?(:retrieve_access_handler)
    ...
    def restrict_to(logicstring, context = {})
      ...
      result = ''
      result = yield if permit?(logicstring, context) && block_given?
      result
    end
  end
end
